...
<html>
	<head>
		...
		<link href="/devoops/http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
		...
		<!--[if lt IE 9]>
				<script src="/devoops/http://getbootstrap.com/docs-assets/js/html5shiv.js"></script>
				<script src="/devoops/http://getbootstrap.com/docs-assets/js/respond.min.js"></script>
		<![endif]-->
	</head>
<body>
<!--Start Header-->
	...
	<div class="container-fluid expanded-panel">
		<div class="row">
			<div id="logo" class="col-xs-12 col-sm-2">
				<a href="/devoops/index.html">DevOOPS</a>
			</div>
			<div id="top-panel" class="col-xs-12 col-sm-10">
				<div class="row">
					<div class="col-xs-8 col-sm-4">
						<a href="/devoops/#" class="show-sidebar">
					...
					<div class="col-xs-4 col-sm-8 top-panel-right">
						<ul class="nav navbar-nav pull-right panel-menu">
							<li class="hidden-xs">
								<a href="/devoops/index.html" class="modal-link">
							...
							<li class="dropdown">
								<a href="/devoops/#" class="dropdown-toggle account" data-toggle="dropdown">
									<div class="avatar">
										<img src="/devoops/img/avatar.jpg" class="img-rounded" alt="avatar" />
									</div>
	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				<li>
					<a href="/devoops/ajax/dashboard.html" class="active ajax-link">
						<i class="fa fa-dashboard"></i>
						<span class="hidden-xs">Dashboard</span>
					</a>
				</li>
				<li class="dropdown">
					<a href="/devoops/#" class="dropdown-toggle">
						<i class="fa fa-bar-chart-o"></i>
						<span class="hidden-xs">Charts</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="/devoops/ajax/charts_xcharts.html">xCharts</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/charts_flot.html">Flot Charts</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/charts_google.html">Google Charts</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/charts_morris.html">Morris Charts</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/charts_coindesk.html">CoinDesk realtime</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="/devoops/#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="/devoops/ajax/tables_simple.html">Simple Tables</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/tables_datatables.html">Data Tables</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/tables_beauty.html">Beauty Tables</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="/devoops/#" class="dropdown-toggle">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="/devoops/ajax/ui_grid.html">Grid</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/ui_buttons.html">Buttons</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/ui_progressbars.html">Progress Bars</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/ui_jquery-ui.html">Jquery UI</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="/devoops/ajax/maps.html">OpenStreetMap</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/map_fullscreen.html">Fullscreen map</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="/devoops/#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="/devoops/ajax/gallery_simple.html">Simple Gallery</a></li>
						<li><a class="ajax-link" href="/devoops/ajax/gallery_flickr.html">Flickr Gallery</a></li>
					</ul>
				</li>
				<li>
					 <a class="ajax-link" href="/devoops/ajax/typography.html">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="/devoops/#">First level menu</a></li>
						<li><a href="/devoops/#">First level menu</a></li>
						<li class="dropdown">
							<a href="/devoops/#" class="dropdown-toggle">
							...
							<ul class="dropdown-menu">
								<li><a href="/devoops/#">Second level menu</a></li>
								<li><a href="/devoops/#">Second level menu</a></li>
								<li class="dropdown">
									<a href="/devoops/#" class="dropdown-toggle">
										<i class="fa fa-plus-square"></i>
									...
									<ul class="dropdown-menu">
										<li><a href="/devoops/#">Three level menu</a></li>
										<li><a href="/devoops/#">Three level menu</a></li>
										<li class="dropdown">
											<a href="/devoops/#" class="dropdown-toggle">
												<i class="fa fa-plus-square"></i>
											...
											<ul class="dropdown-menu">
												<li><a href="/devoops/#">Four level menu</a></li>
												<li><a href="/devoops/#">Four level menu</a></li>
												<li class="dropdown">
													<a href="/devoops/#" class="dropdown-toggle">
														<i class="fa fa-plus-square"></i>
													...
													<ul class="dropdown-menu">
														<li><a href="/devoops/#">Five level menu</a></li>
														<li><a href="/devoops/#">Five level menu</a></li>
														<li class="dropdown">
															<a href="/devoops/#" class="dropdown-toggle">
																<i class="fa fa-plus-square"></i>
															...
															<ul class="dropdown-menu">
																<li><a href="/devoops/#">Six level menu</a></li>
																<li><a href="/devoops/#">Six level menu</a></li>
															</ul>
														</li>
													</ul>
...
<!--<script src="/devoops/http://code.jquery.com/jquery.js"></script>-->
